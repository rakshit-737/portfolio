 ...
 * stack. Never insert this into `Plate.tsx`'s own four-layer stack — an
 * exhibit must stay ambiently visible on first paint and never masked by
 * the lamp: the lamp dramatizes the record, it does not gate it (see
 * DESIGN.md's Lamp-Dramatizes-Never-Gates Rule).
 */
export default function Exhibit({
  ...
  return (
    <figure className={`mt-12 ${wide ? "" : "max-w-2xl"} ${className}`}>
