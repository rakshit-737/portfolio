...
| README fixes: "Deployed in Vercel", blank line before `## Local development`, `/resume.pdf` mentions | None exist in `README.md` today. `/resume.pdf` appears twice in `PRODUCT.md`. |
